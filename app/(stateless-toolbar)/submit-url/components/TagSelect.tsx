...
export default function Select({
  ...
  return (
    ...
    >
      ...
      {expanded && (
        <div className="z-5 absolute top-[85%] ml-[-13.5px] max-h-[100px] w-[calc(100%+3px)] rounded-b-lg border-[1.5px] border-t-0 border-shark-800 bg-shark-950 overflow-y-auto">
